			...
			if(existe(jogoAliens[i][j])) {
					...
					if(jogoArea.aliensMortos >= 35) {
						if(!ocorreu[0]) {
							...
							jogoAliens[i][j].iniciarRitmo(60);
						}
					}
					else if(jogoArea.aliensMortos >= 34) {
						if(!ocorreu[1]) {
							jogoAliens[i][j].cancelarRitmo();
							jogoAliens[i][j].iniciarRitmo(100);
						}
					}
					else if(jogoArea.aliensMortos >= 33) {
						if(!ocorreu[2]) {
							jogoAliens[i][j].cancelarRitmo();
							jogoAliens[i][j].iniciarRitmo(200);
						}
					}
					else if(jogoArea.aliensMortos >= 32) {
						if(!ocorreu[3]) {
							jogoAliens[i][j].cancelarRitmo();
							jogoAliens[i][j].iniciarRitmo(300);
						}
					}
					else if(jogoArea.aliensMortos >= 28) {
						if(!ocorreu[4]) {
							jogoAliens[i][j].cancelarRitmo();
							jogoAliens[i][j].iniciarRitmo(400);
						}
					}
					else if(jogoArea.aliensMortos >= 15) {
						if(!ocorreu[5]) {
							jogoAliens[i][j].cancelarRitmo();
							jogoAliens[i][j].iniciarRitmo(500);
						}
					}	
			}
		}
