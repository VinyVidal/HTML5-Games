...
function MobileMoveButton() {
	...
	this.getIsLeft = function() {
		return isLeft;
	}
	this.setIsLeft = function(value) {
		isLeft = value;
	}
	...
	this.setIsRight = function(value) {
		isRight = value;
	}
	
	this.construir = function(bx, by, bwidth, bheight, bcolor, bisLeft) {
		this.setX(bx);
		this.setY(by);
		this.setWidth(bwidth);
		this.setHeight(bheight);
